...
var mots = [
	...
	{ mot: "deforestation", indice: "Destruction des forêts", texte: "La déforestation a un impact négatif sur la biodiversité et le climat." },
	{ mot: "ecologie", indice: "Science qui étudie les relations entre les êtres vivants et leur environnement", texte: "L'écologie est une science essentielle pour comprendre les enjeux environnementaux actuels." },
	...
	{ mot: "gaz a effet de serre", indice: "Gaz qui contribuent au réchauffement climatique", texte: "Les gaz à effet de serre sont produits par les activités humaines et ont un impact sur le climat." },
	{ mot: "herisson", indice: "Petit mammifère couvert de piquants", texte: "Le hérisson est un animal nocturne qui se nourrit d'insectes et d'autres petits animaux." },
	...
	{ mot: "marecage", indice: "Zone humide où l'eau stagne", texte: "Les marécages abritent une grande diversité d'espèces animales et végétales, mais sont menacés par la destruction des habitats naturels." },
	{ mot: "nenuphar", indice: "Plante aquatique à fleurs", texte: "Le nénuphar est une plante aquatique qui vit dans les étangs et les lacs." },
	{ mot: "ecosysteme", indice: "Ensemble des êtres vivants et de leur environnement", texte: "Un écosystème est constitué d'êtres vivants interagissant avec leur environnement." },
	{ mot: "espece", indice: "Groupe d'individus ayant des caractéristiques communes et pouvant se reproduire entre eux", texte: "La notion d'espèce est fondamentale en biologie." },
	...
	{ mot: "predateur", indice: "Animal qui chasse et tue d'autres animaux pour se nourrir", texte: "Les prédateurs sont des acteurs importants de la régulation des populations animales." },
	{ mot: "dechet", indice: "Matière considérée comme inutile et jetée", texte: "La gestion des déchets est un enjeu majeur pour la préservation de l'environnement." },
	{ mot: "energie", indice: "Capacité à produire un travail ou un mouvement", texte: "L'énergie est indispensable à toute forme de vie." },
	{ mot: "foret", indice: "Formation végétale composée d'arbres et d'autres plantes", texte: "Les forêts abritent une grande diversité d'espèces animales et végétales." },
	{ mot: "ocean", indice: "Vaste étendue d'eau salée recouvrant une grande partie de la surface de la Terre", texte: "Les océans sont des écosystèmes complexes et riches en biodiversité." },
	{ mot: "rechauffement", indice: "Augmentation de la température moyenne de la planète", texte: "Le réchauffement climatique a des conséquences importantes sur la biodiversité." },
]	
	...
	var lettresProposées = "abcdefghijklmnopqrstuvwxyz";
	var lettresHTML = "";
...
document.addEventListener("keydown", function(event) {
	...
	if (/[a-z]/.test(lettrePressee)) { // vérifier que c'est une lettre de l'alphabet
...
var lettresDejaPressees = []; // Tableau pour stocker les lettres déjà pressées
  ...
  document.addEventListener("keydown", function(event) {
    const lettrePressee = event.key.toLowerCase(); // récupérer la lettre pressée
    if (/[a-z]/.test(lettrePressee) && lettresDejaPressees.indexOf(lettrePressee) === -1) { // vérifier que c'est une lettre de l'alphabet et qu'elle n'a pas déjà été pressée
        ...
        afficherMot();
        var boutonLettrePressee = document.getElementsByClassName("lettre")[lettrePressee.charCodeAt(0) - 97];
        console.log(boutonLettrePressee);
		console.log(typeof boutonLettrePressee);
		if (boutonLettrePressee !== null) { // vérifier si le bouton existe
